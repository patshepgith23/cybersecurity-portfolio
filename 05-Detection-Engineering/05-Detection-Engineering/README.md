# 05 - Detection Engineering & Threat Detection
                                                                                                                  ...
                                                                                                                  - - Reputation scoring and implementation
                                                                                                                    - - Vulnerability correlation with network exposure
                                                                                                                      ...
                                                                                                                      - ```
                                                                                                                        ...
                                                                                                                        1. **Threat Detection Design** - Creating detection strategies aligned with organization risk and attack scenarios
                                                                                                                        2. 2. **Risk & Criticality Assessment** - Systematic approaches to identifying high-value assets and threats
                                                                                                                           3. 3. **System Architecture Understanding** - Deep knowledge of systems, dependencies, and attack paths
                                                                                                                              4. 4. **Analytics & Rule Development** - Creating effective SIEM/EDR detection rules with appropriate tuning
                                                                                                                                 5. 5. **Behavioral Analysis** - Establishing baselines and detecting anomalies in user and system behavior
                                                                                                                                    6. 6. **Threat Intelligence Application** - Integrating external threat data into detection strategies
                                                                                                                                       7. 7. **Data Science & Statistical Methods** - Using statistical approaches to identify true positives vs. noise
                                                                                                                                         
                                                                                                                                          8. ---
                                                                                                                                         
                                                                                                                                          9. ## Skills Highlighted
                                                                                                                                         
                                                                                                                                          10. - **SIEM Platforms**: Splunk, ELK Stack, ArcSight, SumoLogic
